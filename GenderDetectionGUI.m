...
% Date: March 2026
    ...
    axPreprocess = axes('Parent', panelTest, 'Position', [0.05 0.05 0.25 0.40]);
    ...
    axClassResult = axes('Parent', panelTest, 'Position', [0.37 0.05 0.25 0.40]);
    set(axClassResult, 'Color', 'white', 'XColor', 'white', 'YColor', 'white');
    title(axClassResult, 'Gender Classification Result Based on AlexNet-CNN', ...
          'FontSize', 9, 'FontWeight', 'bold', 'Color', [0 0.3 0.6]);
